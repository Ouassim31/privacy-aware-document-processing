        ...
        <div>
          ...
          <Container className="w-75 text-center">
            <p className="">
              ...
              check the applicant's income manually. This procedure is not
              ...
              <div className="p-3 ">
                ...
                <ol>
                  ...
                  <li>
                    ...
                    applicant and wait until the applicant has uploaded a
                    document
                  </li>
                  <li>
                    {" "}
                    Once the document was uploaded, select the{" "}
                    <strong>DApp</strong> for the type of processing task you
                    are interested in and execute the task{" "}
                  </li>
                  <li>
            ...
            <Tab eventKey="applicant" title="Applicant">
              <div className="p-3 ">
                <p className="text-center">
                  {" "}
                  If you have been{" "}
                  <strong>invited to provide a document</strong>
                </p>
                <ol>
                  {" "}
                  <li>
